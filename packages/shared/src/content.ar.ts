...
export const ORDER_LABELS_AR: Record<string, OrderLabelsAr> = {
  ...
  'SORT-09': {
    prompt: 'رتّب مراحل حياة الفراشة من الأولى إلى الأخيرة.',
    direction: EARLIEST_AR,
    explanation: 'بيضة، ثم يرقة، ثم شرنقة، ثم فراشة.',
    labels: ['بيضة', 'يرقة', 'شرنقة', 'فراشة'],
  },
  'SORT-10': {
...
export const HOW_TO_PLAY_AR: Record<GameType, HowToPlayAr> = {
  RLGL: {
    ...
    scoringNote: 'الوصول = 80 نقطة + حتى 20 للسرعة. حي عند انتهاء الوقت = حتى 60. الخروج = 0 في هذا السباق، ونقاطك السابقة محفوظة.',
  },
  GEO: {
    title: 'وين الدولة؟',
    ...
    steps: [
      ...
      'انقر لتحديد موقعك، ثم اضغط «ثبّت موقعي».',
      'داخل الدولة = نقاط كاملة، وثبّت بسرعة لمكافأة إضافية.',
    ],
    scoringNote: 'داخل الدولة = 80 + حتى 20 للسرعة. خارجها: كل 500 كم تخصم 10 نقاط.',
  },
  ORDER: {
    title: 'رتّبها!',
    ...
    steps: [
      ...
      'اضغط «ثبّت ترتيبي». كل موضع صحيح = 20 نقطة.',
    ],
    scoringNote: 'كل بطاقة في موضعها الصحيح = 20 نقطة. الأربع صحيحة + تثبيت سريع = حتى 20 نقطة إضافية.',
  },
};
