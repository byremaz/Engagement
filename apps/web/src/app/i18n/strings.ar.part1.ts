...
export const AR_PART1 = {
  ...
  'join.avatar.label': 'اختر شخصيتك',
  'join.avatar.random': 'عشوائي',
  'play.avatar.change': 'تغيير الشخصية',
  'play.avatar.pick': 'اختر شخصيتك',
  'play.avatar.error': 'تعذّر تغيير الشخصية — حاول مرة أخرى.',
